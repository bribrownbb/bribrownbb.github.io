...
function conjugate(){
  ...
  "し"||"ち"||"に"||"ひ"||"み"||"り"||"ぎ"||"じ"||"ぢ"||"び"||"ぴ")){
    conjugWord = genWord.replace("る","られる");
  ...
  //う-Verbs Conjugation rules
      ...
      conjugWord = genWord.replace("う","われる")
      console.log(conjugWord);
      return conjugWord;
  }
  else if(genWord.charAt(genWord.length-1)== "つ"){
      conjugWord = genWord.replace("つ","たれる")
      console.log(conjugWord);
      return conjugWord;
  }
